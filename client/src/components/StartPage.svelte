<script>
  ...
  import bgShape5 from "../assets/bg-shape-5.png";
...
<section class="main__start-page">
  ...
  <img src={startPage3} alt="img-4" class="start__img-4" />

  <header class="start__header">
    <h1 class="start__title">Witaj w seniority</h1>
    <h2 class="start__subtitle">Cieszymy się, że z nami jesteś</h2>
  </header>
</section>
